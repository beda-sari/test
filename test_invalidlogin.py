...
class TestInvalidlogin():
  ...
  def test_invalidlogin(self):
    ...
    WebDriverWait(self.driver, 5).until(expected_conditions.visibility_of_element_located((By.XPATH, "//h3[contains(.,\'Epic sadface: Username is required\')]")))
    assert self.driver.find_element(By.XPATH, "//div[@id=\'login_button_container\']/div/form/div[3]").text == "Epic sadface: Username is required"
    self.driver.find_element(By.ID, "user-name").click()
