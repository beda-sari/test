...
class TestCheckout():
  ...
  def test_checkout(self):
    ...
    self.driver.find_element(By.ID, "first-name").send_keys("eda")
    self.driver.find_element(By.ID, "last-name").click()
    self.driver.find_element(By.ID, "last-name").send_keys("sarı")
    self.driver.find_element(By.ID, "continue").click()
    WebDriverWait(self.driver, 5).until(expected_conditions.visibility_of_element_located((By.XPATH, "//div[@id=\'checkout_info_container\']/div/form/div/div[4]/h3")))
